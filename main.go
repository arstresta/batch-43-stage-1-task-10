...
func addProject(w http.ResponseWriter, r *http.Request) {
	...
	_, err = connection.Conn.Exec(context.Background(), "insert into tb_project(project_name, description, node, react, next, typescript, image, auth_id) values($1, $2, $3, $4, $5, $6,'images.png', $7)", projectName, description, Node, React, Next, TypeScript, AuthId)
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		w.Write([]byte("Message : " + err.Error()))
		return
